...
Para este trabajo, leeremos y analizaremos un libro. La única diferencia es que lo hará R por nosotros. 
Hemos escogido Oliver Twist por ser un libro popular con una trama y ambientes más bien trágicos. Además, hay cambios de entorno según el capítulo, con lo que podemos ver momento a momento los cambios de guión gracias a técnicas de text mining.
