...
En este tercer apartado, se ha realizado una predicción utilizando el método de *k-vecinos*, obteniendo resultados para ambas muestras (validación y estimación), escogiéndose 4 grupos de k-vecinos al tener 4 tipos de empresas **tamaño** (tamaños de empresas).
