...
```
  ...
  + Ya se pueden realizar las **predicciones de la muestra de validación**. En primer lugar, si se observa el gráfico, el modelo captura de forma bastante aceptable los subgrupos y, si bien un árbol de regresión, al trabajar con medias de subgrupos, puede tener un mayor error, ahora se procederá a comparar con el resto. Respecto al dato del error medio obtenido, muestra que el modelo es mejor que el de regresión lineal múltiple.
